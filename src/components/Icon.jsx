/**
 * Icon — SVG icon system para mi-render
 * Reemplaza todos los emojis por iconos vectoriales propios
 */
...
const icons = {
  ...
  undo: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 7v6h6"/>
      <path d="M3 13C5.3 7.7 10.3 4 16 4c5.5 0 9 3.8 9 8s-3.5 8-9 8c-3.5 0-6.6-1.7-8.5-4.3"/>
    </svg>
  ),
